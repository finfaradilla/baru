    ...
    <div class="col-md-10 p-0">
        <div class="card-body text-end">
            ...
            @if (auth()->user()->role_id === 1)
                <a href="/dashboard/users" type="button" class="mb-3 btn button btn-success">
                    Choose from user
                </a>
                <button type="button" class="mb-3 btn button btn-success" data-bs-toggle="modal"
                            ...
                            @foreach ($admins as $admin)
                                <tr>
                                    ...
                                    <td style="font-size: 22px;">
                                        <a href="#" class="editadmin" id="editadmin"
                                ...
                                <!-- Include Edit Modal for each admin -->
