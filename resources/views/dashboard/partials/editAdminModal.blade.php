            ...
            <div class="modal-body" style="text-align: left;">
                <form action="{{ route('admin.update', ['admin' => $admin->id]) }}" method="post" id="editformadmin">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('nomor_induk') is-invalid @enderror" id="nomor_induk" name="nomor_induk" value="{{ old('nomor_induk', $admin->nomor_induk) }}" required>
                        @error('nomor_induk')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
